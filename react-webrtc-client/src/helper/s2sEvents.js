class S2sEvent {
  ...
  static DEFAULT_TOOL_CONFIG = {
    tools: [
      ...
      {
        toolSpec: {
          name: "getKbTool_smarthome",
          description: "get MQTT topics and payload formats for controlling smart home devices, like light & smart lock in living room, light and oven in kitchen, and light in bedroom. Or get information about smart home device manuals",
          inputSchema: {
            json: JSON.stringify({
              "type": "object",
              "properties": {
                "query": {
                  "type": "string",
                  "description": "The question about MQTT topic definition for lights & lock & oven in living room, kitchen, or bedroom. Or the question about smart home devices."
                }
              },
              "required": []
            }
